...
def load_gui(self):
    ...
    #buttons
    self.btn_browse1 = Button(self.master, width=12, height=1, text="Browse...", command=lambda: File_Browser_Function.ask_source(self))
    self.btn_browse1.grid(row=1, column=1, padx=(15, 0), pady=(25, 10), sticky=W)

    self.btn_browse2 = Button(self.master, width=12, height=1, text="Browse...", command=lambda: File_Browser_Function.ask_destination(self))
